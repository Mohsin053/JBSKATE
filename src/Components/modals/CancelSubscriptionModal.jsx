...
const CancelSubscriptionModal = ({ showModal, user }) => {
    ...
    <dialog id="my_modal_1" className="modal">
      <div className="modal-box bg-white p-0">
        ...
        >
          ...
          <h3 className="font-medium font-sans text-[18px] text-black">
            Cancel Subscription
          </h3>
        ...
        <div className="p-[15px] flex flex-col items-center justify-center gap-[15px] ">
          ...
          <p className=" w-[50%] text-[18px] text-black text-center font-normal font-sans">
            Are you sure you want to cancel the subscription of “{user.name}”
          </p>
